...
OpenSpending.BubbleTree.Styles.Cofog = {
	'01': { icon: 'styles/icons/Bulgaria.png', color: '#C75746' },
	...
	'01-2-2': { icon: 'styles/icons/euro.svg' },
	'0': { icon: 'styles/icons/pig.svg' },


	'01': { icon: 'styles/icons/Bulgaria.png', color: '#C75746' },
	'1': { icon: 'styles/icons/government-uk.svg', color: '#C75746' },
...
'2': { icon: 'css/styles/icons/defence.svg', color: '#0AB971' },
